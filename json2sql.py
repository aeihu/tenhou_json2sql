...
def tenhou_func(tab1, index, tab2=[]):
	if index < len(tab1):
		if tab1[index] == 60:
			return str(tab1[index])+'|'+str(tenhou_func(tab2, index))
		else:
			return tab1[index]
	else:
		return ''
	...
	for i in range(0, len(json_obj["log"])):
		...
		strs.append(str.format('\nINSERT INTO tenhou_paipu('
			...
			%(json_obj["ref"],json_obj["log"][i][0][0],json_obj["log"][i][16][0],json_obj["log"][i][0][1],json_obj["log"][i][0][2],
				...
				json_obj["log"][i][6],
				p1_k,p1_a,p1_r,
				tenhou_func(json_obj["log"][i][6], 0, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 1, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 2, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 3, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 4, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 5, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 6, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 7, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 8, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 9, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 10, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 11, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 12, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 13, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 14, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 15, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 16, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 17, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 18, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 19, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 20, json_obj["log"][i][5]),
				tenhou_func(json_obj["log"][i][6], 21, json_obj["log"][i][5]),
				#p2
				json_obj["log"][i][8],
				p2_c,p2_p,p2_m,
				...
				json_obj["log"][i][9],
				p2_k,p2_a,p2_r,
				tenhou_func(json_obj["log"][i][9], 0,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 1,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 2,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 3,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 4,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 5,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 6,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 7,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 8,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 9,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 10,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 11,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 12,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 13,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 14,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 15,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 16,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 17,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 18,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 19,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 20,json_obj["log"][i][8]),
				tenhou_func(json_obj["log"][i][9], 21,json_obj["log"][i][8]),
				#p3
				json_obj["log"][i][11],
				p3_c,p3_p,p3_m,
				...
				json_obj["log"][i][12],	
				p3_k,p3_a,p3_r,
				tenhou_func(json_obj["log"][i][12], 0,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 1,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 2,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 3,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 4,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 5,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 6,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 7,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 8,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 9,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 10,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 11,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 12,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 13,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 14,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 15,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 16,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 17,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 18,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 19,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 20,json_obj["log"][i][11]),
				tenhou_func(json_obj["log"][i][12], 21,json_obj["log"][i][11]),
				#p4
				json_obj["log"][i][14],	
				p4_c,p4_p,p4_m,
				...
				json_obj["log"][i][15],	
				p4_k,p4_a,p4_r,
				tenhou_func(json_obj["log"][i][15], 0,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 1,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 2,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 3,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 4,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 5,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 6,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 7,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 8,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 9,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 10,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 11,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 12,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 13,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 14,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 15,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 16,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 17,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 18,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 19,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 20,json_obj["log"][i][14]),
				tenhou_func(json_obj["log"][i][15], 21,json_obj["log"][i][14])
				)
		))
